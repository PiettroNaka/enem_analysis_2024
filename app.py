...
from utils.database import load_combined_data, get_table_info
...
# Página: Início
if page == "📊 Início":
    st.markdown("<h1 class='main-title'>Análise Exploratória - ENEM 2024</h1>", unsafe_allow_html=True)
...
# Página: Análise Exploratória
    ...
    # Carrega dados
    df = load_combined_data(limit=100000)  # Limita para performance
    ...
    if qualitative_cols:
        selected_qual = st.selectbox("Selecione uma variável qualitativa:", qualitative_cols)
    ...
    if quantitative_cols:
        selected_quant = st.selectbox("Selecione uma variável quantitativa:", quantitative_cols)
    ...
    if quantitative_cols:
        # Seleciona apenas colunas de notas para correlação
...
# Página: Amostragem
    ...
    df_pop = load_combined_data(limit=500000)  # Carrega mais dados para amostragem
...
# Página: Relatório
    ...
    st.info("Relatório técnico completo em desenvolvimento...")
